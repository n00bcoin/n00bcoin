...
After completing windows setup then run windows command line (cmd)
  cd daemon
  n00bcoind
You would need to create a configuration file n00bcoin.conf in the default
wallet directory. Grant access to n00bcoind.exe in anti-virus and firewall
...
n00bcoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
n00bcoind stop
Start up the new n00bcoind (0.3.0).
